    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "rodrigo-admin@lima.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Lima123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "rodrigo-client@lima.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 11111-1111",
                FirstName = "Rodrigo",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Lima123$").GetAwaiter().GetResult();
